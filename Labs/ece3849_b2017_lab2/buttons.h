...
#define BUTTON_SCAN_RATE 200 // button scanning interrupt rate in Hz
#define BUTTON_INT_PRIORITY 1 // button interrupt priority (higher number is lower priority)
